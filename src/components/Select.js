  ...
  return (
    <div className="w-full">
      ...
      >
        <div
          onClick={() => setIsOpenSelect((prev) => !prev)}
          className={`px-3 flex gap-2 justify-between active:bg-gray-50 border-gray-300 border w-full items-center h-full ${
            isOpenSelect ? "rounded-t-lg" : "rounded-lg hover:border-gray-400"
          }`}
        >
          {currentTitle && (
            <>
        ...
        <div
          className={`scrollbar overflow-auto max-h-40 absolute z-30 -mt-[1px] w-full flex-col p-2 gap-1 bg-white border border-gray-300 rounded-b-lg ${
